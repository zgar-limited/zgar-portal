        ...
        {allImages.length > 1 && (
            <>
                <button 
                    ...
                    className="p-2 shadow-sm position-absolute start-0 top-50 translate-middle-y btn btn-light rounded-circle ms-3 d-flex align-items-center justify-content-center"
                ...
                <button 
                    ...
                    className="p-2 shadow-sm position-absolute end-0 top-50 translate-middle-y btn btn-light rounded-circle me-3 d-flex align-items-center justify-content-center"
                    style={{ width: 40, height: 40 }}
                >
        ...
        <div className="gap-2 pb-2 overflow-auto d-flex">
          {allImages.map((img, idx) => (
            <button
              ...
              className={`border-0 p-0 rounded-3 overflow-hidden position-relative flex-shrink-0 ${selectedIndex === idx ? 'ring-2 ring-primary' : ''}`}
