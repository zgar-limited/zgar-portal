  ...
  return (
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="grid gap-2 card-responsive">
          {cardData.map((card, index) => {
            ...
            if (enableStars) {
              return (
                ...
                >
                  <div className="relative flex justify-between gap-3 text-white card__header">
                    <span className="text-base card__label">{card.label}</span>
                  </div>
                  <div className="relative flex flex-col text-white card__content">
