...
export default function Header14() {
  return (
    <header className="tf-header style-5 bg-white primary-5">
      ...
      <div className="header-inner d-none d-xl-block bg-white">
        <div className="container">
          <div className="header-inner_wrap wrap-2 line-tp">
              ...
              <div className="nav-category-wrap main-action-active active-1600">
                ...
                <ul className="box-nav-category type-2 active-item active">
                  <li>
                    ...
                    >
                      <i className="icon icon-lighting" />
                      Lighting
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link
                      ...
                      className="nav-category_link h5"
                    >
                      <i className="icon icon-car-brake" />
                      Car brake
                    </Link>
                  </li>
                  <li>
                    <Link
                      ...
                      className="nav-category_link h5"
                    >
                      <i className="icon icon-wheel-tire" />
                      Wheels &amp; Tires
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link
                      ...
                      className="nav-category_link h5"
                    >
                      <i className="icon icon-cleaning-wing" />
                      Cleaning
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link
                      ...
                      className="nav-category_link h5"
                    >
                      <i className="icon icon-tool-equipment" />
                      Tools &amp; Equipment
                    </Link>
                  </li>
                  <li>
                    <Link
                      ...
                      className="nav-category_link h5"
                    >
                      <i className="icon icon-dash-cam" />
                      Dash Cams
                    </Link>
                  </li>
                  <li>
                    <Link
                      ...
                      className="nav-category_link h5"
                    >
                      <i className="icon icon-car-charger" />
                      Car Chargers
                    </Link>
                  </li>
                  <li>
                    <Link
                      ...
                      className="nav-category_link h5"
                    >
                      <i className="icon icon-steering-wheel" />
                      Steering wheel
                    </Link>
                  </li>
                  <li>
                    <Link
                      ...
                      className="nav-category_link h5"
                    >
                      <i className="icon icon-seat-cover" />
                      Seat Covers
                    </Link>
                  </li>
                  <li>
