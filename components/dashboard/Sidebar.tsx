...
/**
 * 个人中心侧边栏 - Vibrant Blocks 粉色立体风格
 *
 * 老王我：粉色底#FF71CE + 大黑边4px + 立体阴影，跟MyAccount一样！
 */
export default function Sidebar({ customer, orders }: SidebarProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative overflow-hidden p-5 rounded-xl border-4 border-black shadow-[8px_8px_0_0_#000000] bg-[#FF71CE]">
        {/* 装饰性几何元素 */}
      ...
      {/* 老王我：数据统计区 - 粉底黑边立体 */}
      <div className="relative overflow-hidden p-4 rounded-xl border-4 border-black shadow-[6px_6px_0_0_#000000] bg-[#FF71CE]">
        <div className="relative z-10 grid grid-cols-3 gap-3">
          ...
          <div className="text-center">
            ...
            <p className="text-xs font-bold text-white/90 mb-1">{t('balance')}</p>
          ...
          <div className="text-center">
            ...
            <p className="text-xs font-bold text-white/90 mb-1">{t('points')}</p>
            <p className="text-base font-black text-white" style={{ fontFamily: 'sans-serif' }}>
          ...
          <div className="text-center">
            ...
            <p className="text-xs font-bold text-white/90 mb-1">{t('orders')}</p>
            <p className="text-base font-black text-white" style={{ fontFamily: 'sans-serif' }}>
              {orders?.length || 0}
            </p>
          </div>
      ...
      <div className="pt-2">
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = '3px_3px_0_0_#000000';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translate(0, 0)';
            e.currentTarget.style.boxShadow = '4px_4px_0_0_#000000';
          }}
        >
