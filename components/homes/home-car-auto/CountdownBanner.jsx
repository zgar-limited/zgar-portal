    ...
    <section className="themesFlat">
      <div className="container">
        <div className="tf-grid-layout md-col-2">
          <div className="box-image_V06 type-space-2 has-overlay overlay-5 hover-img rounded-0">
            <ul className="product-badge_list">
              <li className="product-badge_item flash-sale rounded-0">
                <i className="icon icon-thunder" /> Flash sale
              </li>
            </ul>
            <Link href={`/shop-default`} className="box-image_image img-style">
              <Image
                src="/images/section/box-image-34.jpg"
                alt="IMG"
                className="lazyload"
                width={1392}
                height={524}
            ...
            <div className="box-image_content wow fadeInUp">
              <h4 className="title">
                <Link href={`/shop-default`} className="link text-white">
                  OASIS AUTO Custom Fit Seat <br />
                  Covers for Toyota Camry
                </Link>
              </h4>
              <Link
                href={`/shop-default`}
          ...
          <div className="box-image_V06 type-space-2 has-overlay overlay-6 hover-img rounded-0">
            <ul className="product-badge_list">
              <li className="product-badge_item sale h6 rounded-0">20% OFF</li>
            </ul>
            <Link href={`/shop-default`} className="box-image_image img-style">
              <Image
                src="/images/section/box-image-35.jpg"
                alt="IMG"
                className="lazyload"
                width={1392}
                height={524}
            ...
            <div className="box-image_content wow fadeInUp">
              <h4 className="title">
                <Link href={`/shop-default`} className="link text-white">
                  6DCT250 DPS6 Auto Transmission <br />
                  Dual Clutch Drum Clutches
                </Link>
              </h4>
              <Link
                href={`/shop-default`}
          ...
          <div className="banner-cd_v02 primary-5 rounded-0 wd-full wow fadeInUp">
            <div className="banner_title">
              ...
              <h4 className="text-primary">Hurry up offer ends in:</h4>
            </div>
            <div className="count-down_v02 rounded-0">
